...
DATE: Thursday, January 08, 2015     TIME: 9:16:09 AM
PROJECT: WangJ_SAS_project_01072015
PROJECT PATH: C:\Users\jwang03\Desktop\jwang03\Assignments\Assignment 2 20150107\WangJ_SAS_project_01072015.egp
---------------------------------------- */
...
%LET _CLIENTPROJECTPATH='C:\Users\jwang03\Desktop\jwang03\Assignments\Assignment 2 20150107\WangJ_SAS_project_01072015.egp';
%LET _CLIENTPROJECTNAME='WangJ_SAS_project_01072015.egp';
...
/* -------------------------------------------------------------------
   ...
   Generated on: Thursday, January 08, 2015 at 9:14:58 AM
...
/* -------------------------------------------------------------------
   ...
   Generated on: Thursday, January 08, 2015 at 9:14:59 AM
...
PROC DATASETS NOLIST NODETAILS; 
   CONTENTS DATA=LUCIA.MEPS_FULLYR_2012_SAS7 OUT=WORK.SUCOUT1;

RUN;

DATA WORK.CONTContentsForMEPS_FULLYR_2012_(LABEL="Contents Details for MEPS_FULLYR_2012_SAS7");
   SET WORK.SUCOUT1;
RUN;
...
CREATE TABLE WORK.SCTABLE AS
	SELECT * FROM WORK.SCVIEW
		WHERE memname='MEPS_FULLYR_2012_SAS7';
QUIT;
